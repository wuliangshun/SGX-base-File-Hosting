...
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_open, (const char* path));
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_create, (const char* path));
...
sgx_status_t ecall_encrypt_file(sgx_enclave_id_t eid, int* retval, const char* input_file, const char* output_file);
sgx_status_t ecall_decrypt_file(sgx_enclave_id_t eid, int* retval, const char* input_file, const char* username);
